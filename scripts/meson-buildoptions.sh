...
meson_options_help() {
  ...
  printf "%s\n" '  --enable-uwp             Build with UWP/Xbox-compatible Windows API'
  printf "%s\n" '                           restrictions'
...
_meson_option_parse() {
  case $1 in
    ...
    --enable-xaudio2) printf "%s" -Dxaudio2=enabled ;;
    --disable-xaudio2) printf "%s" -Dxaudio2=disabled ;;
