...
#if defined(CONFIG_UWP) && defined(_WIN32)

void flush_idcache_range(uintptr_t rx, uintptr_t rw, size_t len)
{
    /*
     * The codeGeneration contract requires this call after publishing code
     * to an executable mapping, including on coherent x86-64 processors.
     */
    FlushInstructionCache(GetCurrentProcess(), (const void *)rx, len);
}

#elif defined(__x86_64__) || defined(__s390__)
